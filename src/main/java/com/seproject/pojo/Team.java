...
public class Team {
    ...
    public Team(int teamID, int leaderID, String teamName, String headSculpturePath, String teamDescription, int maxMember, String teamPassword, boolean encryption, int teamAudit) {
        this.teamID = teamID;
