...
public class TeamUpdateReq {
    ...
    public TeamUpdateReq() {
    }

    public TeamUpdateReq(int teamID, int leaderID, String teamName, String headSculpturePath, String teamDescription, int maxMember, String teamPassword, boolean encryption, int teamAudit) {
        this.teamID = teamID;
